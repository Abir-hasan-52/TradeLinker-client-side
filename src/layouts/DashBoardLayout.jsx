...
import TradeLinkerLogo from "../Components/Shared/TradeLinkerLogo/TradeLinkerLogo";
  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-side">
        ...
        ></label>
        <ul className="menu bg-gray-50 text-red-900 min-h-full w-80 p-4 font-medium">
          {/* Logo */}
          <div className="mb-6">
            <TradeLinkerLogo />
          </div>
